...
class ExcitedTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('excited')->insert([
        [
          'sentence' => 'I am very excited every day that I could get along with my doukis.',
        ],
        [
          'sentence' => "Our team felt excited, because today's training was very meaningful for us.",
        ],
        [
        ...
        [
          'sentence' => "We are excited to learn many things every day. Our team always share our feelings to work at the end of the day. This opportunity is so good for us to improve ourselves, so I am very happy to be with this team.",
        ],
        [
          'sentence' => " I was excited about today's training. Because our team had many chances to talk with other team members and so I could make a lot of friends.",
        ],
        [
        ...
        [
          'sentence' => "I was so excited about this training because there are a lot of things to learn. It is happy to have this opportunity. So, I will do everything aggressively.",
        ],
        [
