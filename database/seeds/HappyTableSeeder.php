...
class HappyTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('happy')->insert([
        ...
        [
          'sentence' => "I am very happy and grateful to take part in this wonderful team. I am so lucky that I was able to meet my team members.",
        ],
        [
          'sentence' => "We had a great day, because we could solve our problem by cooperating with each other. I thought that we could deepen our solidarity.",
        ],
        [
          'sentence' => "I am so happy that I am making good progress day by day. I would like to keep studying for my growth as a business person.",
        ],
        [
          'sentence' => "I was really happy that our team members accepted my idea. I thought that it is important to convey my opinion logically.",
        ],
        [
       ...
       [
        ...
        [
          'sentence' => "We were able to communicate well in our group. I felt very happy to have a good relationship with my team members.",
        ],
        [
