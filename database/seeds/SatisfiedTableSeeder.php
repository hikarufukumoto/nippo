    ...
    public function run()
    {
      DB::table('satisfied')->insert([
       [
        ...
        [
          'sentence' => "Coding all day is one of my greatest satisfactions. I will keep on working hard during this training.",
        ],
        [
          'sentence' => "I am satisfied to the fact that Rakuten is a perfect company. I am proud of myself.",
        ],
        [
          'sentence' => "I wanted to satisfy my team member's curiosity by talking interesting stories to them.",
        ],
        [
        ...
        [
         ...
         [
          'sentence' => "I am satisfied with being a member of Rakutenian. The reason is I can get a beneficial new grads' training every day. So, I want to contribute Rakuten, and I want to work hard in my future section.",
        ],
         [
          'sentence' => "Currently, I'm satisfied with my growth during this new grads' training. I could improve my English skill and get a good presentation skill. I want to keep an effort and grow up more.",
        ],
         [
         ...
         [
          'sentence' => "At first, I couldn't understand why we did new grad's training. But now, I was fully satisfied with new grad's training because I noticed that every content about new grad's training made me growth.",
        ],
         [
          'sentence' => "I was fully satisfied with today's training. I noticed that every content made me growth. I had to appreciate GHR that how wonderful product GHR made.",
        ],
         [
        ...
        [
          'sentence' => "I was surprised how new grad's training perfect. I could learn anything every day and almost all of them was meaningful. I was quite satisfied with it.",
        ],
        [
