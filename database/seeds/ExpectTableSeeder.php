...
class ExpectTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('expect')->insert([
        ...
        [
          'sentence' => "I hope my teammate are looking forward to meeting and talking with me because I feel that my teammate seems to be hate me.",
        ],
        [
        ...
        [
          'sentence' => "I am looking forward to meeting my colleagues tomorrow. To tell the truth it will be the first time for me to meet my colleagues in private.",
        ],
        [
          'sentence' => "I 'm looking forward to getting a good chance.  In preparation for the forthcoming, I must study hard.",
        ],
        [
          'sentence' => "My teammates were looking forward to listening a speech. In my opinion, there are a lot of experienced people, so it is meaningful for us to listen  senpai's speech.",
        ],
        [
          'sentence' => "I’m looking forward to creating service with my teammate so much. In order to do that , I must study hard.",
        ],
        [
        ...
        [
          'sentence' => "All my teammates were looking forward to get a good opportunity as today. I thought that this company has a lot of exciting person and opportunities.",
        ],
        [
          'sentence' => "I am looking forward to starting new things. Because I can learn from them. without haste, but without rest.",
        ],
        [
          'sentence' => "I’m looking forward to achieving dreams with my team-members. If you can dream it , you do it. This is my favorite word.",
        ],
        [
          'sentence' => "My favorite words is that all your dreams can come true if you have the courage to pursue them. I am looking forward to achieving  dreams by cooporating with sworn doukis.",
        ],
         [
          'sentence' => "I am looking forward to talking with doukis about future career because I am worried about future career.",
        ],
