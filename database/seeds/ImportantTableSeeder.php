...
class ImportantTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('important')->insert([
        ...
        [
          'sentence' => "It is very important to have the mind of security.",
        ],
        [
        ...
        [
          'sentence' => "Today, I realized the importance to work as a team, so I'll take care to contribute our teammates from tomorrow.",
        ],
        [
          'sentence' => "Today, I was here at 7am, and I reviewed yesterday's training content for a hour. I realized the importance of reviewing training's content. I want to keep it in my mind",
        ],
        [
